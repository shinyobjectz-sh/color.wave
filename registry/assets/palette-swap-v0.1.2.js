  ...
  wb.settings.addSection({
    ...
    mount(root) {
      root.innerHTML = `
        <div class="ps-wrap">
          <p class="ps-hint">
            Recolors any composition. Hex colors in your composition
            get auto-mapped to the four slots (background, foreground,
            mute, accent) by HSL. For precise control, use
            <code>var(--cw-bg)</code> / <code>--cw-fg</code> /
