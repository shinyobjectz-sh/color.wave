// decode — Blob → mono Float32 PCM @ 16 kHz, plus PCM → WAV blob.
// Same pattern as silence-cutter / auto-captions (each plugin ships
// its own copy to keep distribution self-contained).
